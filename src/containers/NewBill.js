...
export default class NewBill {
	...
	handleChangeFile = e => {
		...
		if (acceptedExtensions) {
			...
			this.document.querySelector('.error--image-entension').style.display = 'block'
			this.fileInput.value = null
			console.error('Les extensions différentes de jpg, jpeg ou png ne sont pas autorisées')
		}
	}
